...
public class MainActivity extends AppCompatActivity implements OnBluetoothDeviceClickedListener {
    ...
    public static String KEY = "BluetoothLeService";
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                //Intent i = new Intent(MainActivity.this, MainActivityV2.class);
...
//        builder.create().show();
        ...
        //final EditText ed = (EditText)dialog.findViewById(R.id.ed);
        ...
        btn1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                String text = "up";//;ed.getText().toString();
                btSendBytes(text.getBytes());
                return false;
            }
        });
        ...
        btn2.setOnTouchListener(new View.OnTouchListener() {
            ...
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                String text = "down";//;ed.getText().toString();
                btSendBytes(text.getBytes());
                return false;
            }
        });
        ...
        btn3.setOnTouchListener(new View.OnTouchListener() {
            ...
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                String text = "left";//;ed.getText().toString();
                btSendBytes(text.getBytes());
                return false;
            }
        });
        ...
        btn4.setOnTouchListener(new View.OnTouchListener() {
            ...
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                String text = "right";//;ed.getText().toString();
                btSendBytes(text.getBytes());
                return false;
            }
        });
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String text = "stop";//;ed.getText().toString();
                btSendBytes(text.getBytes());
               // return false;
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_ENABLE_BT) {
            ...
            mBluetoothLeService.disconnect();
        } else if (resultCode == GO_UP) {
            btSendBytes("up".getBytes());
        }
